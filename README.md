...
Все числа вычисляет детерминированный движок. Модель получает готовый результат
и объясняет его человеческим языком.
...
В планах — сохранение и сравнение сценариев, оптимизатор и агент с инструментами.
**Эти возможности пока не реализованы.**

[Продуктовые задачи](docs/TASKS.md) · [Целевая архитектура](docs/ARCHITECTURE.md)
